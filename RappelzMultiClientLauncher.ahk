...
DownloadUpdate(NewVersion) {
    ...
    ZipURL := "https://github.com/Joshmccoy14/Rappelz-Automation-Nexus/archive/refs/heads/main.zip"
    ...
    Loop, Files, %ExtractPath%\Rappelz-Automation-Nexus-main\*.*, FDR
    {
        RelPath := StrReplace(A_LoopFileFullPath, ExtractPath . "\Rappelz-Automation-Nexus-main\")
